...
///
/// Built on 2022-11-05 at 16:44 UTC
...
class _StringsFormEn {
  ...
  late final _StringsFormErrorTextsEn errorTexts =
      _StringsFormErrorTextsEn._(_root);
}
...
class _StringsFormErrorTextsEn {
  ...
  String get alphanumeric =>
      '{label} can only consist of latin letters and numbers';
}
...
class _StringsRu implements _StringsEn {
  ...
  // Translations
  @override
  late final _StringsFormRu form = _StringsFormRu._(_root);
  @override
...
class _StringsFormRu implements _StringsFormEn {
  ...
  // Translations
  @override
  late final _StringsFormLabelsRu labels = _StringsFormLabelsRu._(_root);
  @override
  late final _StringsFormErrorTextsRu errorTexts =
      _StringsFormErrorTextsRu._(_root);
}
...
class _StringsAuthRu implements _StringsAuthEn {
  ...
  @override
  String get notHaveAccount => 'Нет учётной записи?';
  @override
  String get haveAccount => 'Уже есть учётная запись?';
  @override
  String get loginTitle => 'С возвращением!';
  @override
  String get signUpTitle => 'Давай начнём!';
  @override
  Map<String, String> get loginErrors => {
...
class _StringsFormErrorTextsRu implements _StringsFormErrorTextsEn {
  ...
  @override
  String get alphanumeric =>
      '{{label}} может состоять только из латинских букв и цифр';
}
...
extension on _StringsEn {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'form.labels.username':
        return 'username';
      case 'form.labels.name':
        return 'name';
      case 'form.labels.password':
        return 'password';
      case 'form.errorTexts.alphanumeric':
        return '{label} can only consist of latin letters and numbers';
      case 'unknownError':
      ...
      case 'auth.signUp':
        return 'sign up';
      case 'auth.notHaveAccount':
        return 'Need an account?';
      case 'auth.haveAccount':
        return 'Already have a account?';
      case 'auth.loginTitle':
        return 'Welcome back!';
      case 'auth.signUpTitle':
        return 'Let\'s get started!';
      case 'auth.loginErrors.403':
        return 'Wrong username or password🤔';
      case 'auth.loginErrors.500':
        return 'Server error. Sorry💀';
      case 'auth.signUpErrors.403':
        return 'A user with the same username already exists🤔';
      case 'auth.signUpErrors.500':
        return 'Server error. Sorry💀';
      case 'statusCode.400':
        return 'Request data failed server validation  (status code: 400)';
      case 'statusCode.403':
        return 'No access (status code: 403)';
      case 'statusCode.404':
        return 'Nothing found (status code: 404)';
      case 'statusCode.500':
        return 'Server error. Sorry >_< (status code: 500)';
      default:
        return null;
    }
  }
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'form.labels.password':
        return 'пароль';
      case 'form.errorTexts.alphanumeric':
        return '{{label}} может состоять только из латинских букв и цифр';
      case 'unknownError':
      ...
      case 'auth.notHaveAccount':
        return 'Нет учётной записи?';
      case 'auth.haveAccount':
        return 'Уже есть учётная запись?';
      case 'auth.loginTitle':
      ...
      case 'auth.loginErrors.500':
        return 'Ошибка сервера. Извините💀';
      case 'auth.signUpErrors.403':
