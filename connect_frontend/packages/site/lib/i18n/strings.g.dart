...
///
/// Built on 2022-11-27 at 15:42 UTC
...
class _StringsFormErrorTextsEn {
  ...
  // Translations
  String alphanumeric({required Object field}) =>
      '${field} can only consist of latin letters and numbers';
}
...
class _StringsFormErrorTextsRu implements _StringsFormErrorTextsEn {
  ...
  @override
  String alphanumeric({required Object field}) =>
      '${field} может состоять только из латинских букв и цифр';
}
